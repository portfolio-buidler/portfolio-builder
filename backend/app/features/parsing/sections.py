...
SECTION_HEADERS = re.compile(
    r"(?im)^\s*(SUMMARY|OBJECTIVE|PROFILE|ABOUT|EXPERIENCE|PROFESSIONAL EXPERIENCE|EMPLOYMENT HISTORY|WORK EXPERIENCE|PROJECTS|EDUCATION|SKILLS|TECHNICAL SKILLS|TOOLS & TECHNOLOGIES|TOOLS|TECHNOLOGIES|TECH STACK|STACK)\b[:\-]?\s*$"
)
